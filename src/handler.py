...
def getBatch(listParams, start, finish, X_batch, Y_batch):
    param = listParams[1].split(";")
    print(param[2] + "- " + param[3] + " - " + param[4] + "  - " + param[5])
...
if __name__ == '__main__':
    start_path = "/Users/manhhung/Documents/BKHN/ML/workspace/pre_football/football-results-prediction-ml/txt"
    # start_path = "D:\\MachineLearning\\football-results-prediction-ml\\txt"

    teams_files = getFilesData(start_path)
    print(len(teams_files))
